...
def run_recoverai(dataset):
    total = len(dataset)
    if dataset and ml_model.training_rows == 0:
    ...
    for p in dataset:
        ...
        model_input = {**p, 'ml_recoverability': ml_prediction['recoverability_probability'], 'ml_confidence': ml_prediction['confidence']}
